    ...
    <section className="py-12 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
          {ugcData.map((item) => (
            <button
              ...
              aria-label={`Open category ${item.category}`}
              className="group relative overflow-hidden rounded-2xl aspect-square cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-black/10"
            >
              <img
                src={item.image}
                alt={item.category}
              ...
              {/* Gradient overlay + label — show on hover AND focus-visible */}
              <div className="absolute inset-0 bg-linear-to-t from-black/70 via-black/10 to-transparent opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-300 flex items-end">
                <div className="w-full px-3 pb-3">
                  <span className="inline-flex rounded-full bg-white/95 px-3 py-1 text-xs font-semibold text-gray-900 shadow-sm">
                    {item.category}
                  </span>
        ...
        <div className="text-center mt-8">
          <button
            type="button"
            className="inline-flex items-center justify-center rounded-full border border-gray-900 bg-gray-900 text-white px-6 py-2.5 text-sm font-semibold hover:bg-gray-800 hover:border-gray-800 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-black/10"
            aria-label={ctaLabel}
            onClick={() => {
              /* if you want navigation, call router here */
            }}
          >
            {ctaLabel}
          </button>
